  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 max-w-[1400px] mx-auto my-8 px-4 md:px-8">
      <aside className="w-full md:w-[260px] shrink-0 bg-white p-6 rounded-sm border border-border h-fit md:sticky md:top-[130px] shadow-sm">
        <h3 className="text-xl mb-6 text-text-primary font-semibold">
          Filters
        </h3>

        <div className="mb-6 pb-6 border-b border-border last:border-b-0">
          <label className="block mb-2 font-semibold text-text-primary text-sm">
            Category
          </label>
          <select
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col">
                <Link to={`/product/${product.id}`} className="no-underline">
                  <h3 className="text-sm text-text-primary mb-2 font-medium overflow-hidden text-ellipsis line-clamp-2 hover:text-secondary transition-colors">
                    {product.name}
                  </h3>
                </Link>
                <p className="text-xs text-text-secondary mb-3 overflow-hidden text-ellipsis line-clamp-2">
                  {product.description}
                </p>
