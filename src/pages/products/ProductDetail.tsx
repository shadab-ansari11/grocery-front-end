      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-[1400px] mx-auto my-8 px-4 md:px-8">
          ...
          <div className="flex gap-4 overflow-x-auto pb-2">
            {images.map((img, index) => (
              <img
                ...
                className={`w-20 h-20 object-cover border border-border rounded-sm cursor-pointer transition-all ${
                  selectedImage === index
        ...
        <div className="flex-1">
          ...
          <div className="mb-8 border-t border-b border-border py-6">
            <div className="mb-6 last:mb-0">
              ...
              <div className="flex items-center border border-border rounded-sm w-max">
                <button
                  className="w-10 h-10 flex items-center justify-center bg-gray-50 border-none cursor-pointer hover:bg-gray-100 text-lg"
          ...
          <div className="flex gap-4 mb-8">
            <button
              className="flex-1 py-4 bg-primary text-white text-lg font-bold rounded-sm border-none cursor-pointer transition-all hover:bg-primary-dark shadow-md hover:shadow-lg"
              onClick={handleAddToCart}
            >
              Add to Cart
            </button>
            <button className="flex-1 py-4 bg-secondary text-white text-lg font-bold rounded-sm border-none cursor-pointer transition-all hover:bg-secondary-dark shadow-md hover:shadow-lg">
              Buy Now
            </button>
          </div>
          ...
          {relatedProducts.map((p) => (
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col">
                <h3 className="text-sm text-text-primary mb-2 font-medium overflow-hidden text-ellipsis line-clamp-2">
                  {p.name}
                </h3>
